...
Sub-frame rendering is now an option ("frame settings") in the "setting up your farm" menu. Also there is a "job summary" available too. Various other improvements.
